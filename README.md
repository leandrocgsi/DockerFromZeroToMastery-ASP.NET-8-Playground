...
[![Continuous Integration with Github Actions](https://github.com/leandrocgsi/DockerFromZeroToMastery-ASP.NET-8-Playground/actions/workflows/continuous-integration.yml/badge.svg)](https://github.com/leandrocgsi/DockerFromZeroToMastery-ASP.NET-8-Playground/actions/workflows/continuous-integration.yml)
![Forks](https://img.shields.io/github/forks/leandrocgsi/DockerFromZeroToMastery-ASP.NET-8-Playground)
![Stars](https://img.shields.io/github/stars/leandrocgsi/DockerFromZeroToMastery-ASP.NET-8-Playground)
![Last Commit](https://img.shields.io/github/last-commit/leandrocgsi/DockerFromZeroToMastery-ASP.NET-8-Playground)
